...
INSERT INTO comment (comment_id, path, bug_id, author, comment_date, comment)
VALUES (1, '1/', 1, 1, now(), '이 버그의 원인이 뭘까'),
       (2, '1/2/', 1, 2, now(), '널 포인터 때문인 것 같아'),
       (3, '1/2/3/', 1, 1, now(), '아니, 그건 확인해봤어'),
       (4, '1/4/', 1, 3, now(), '입력 값이 유효한지 확인'),
       (5, '1/4/5/', 1, 2, now(), '그래, 그게 버그야'),
       (6, '1/4/6', 1, 1, now(), '그래 확인 코드 추가'),
       (7, '1/4/6/7/', 1, 3, now(), '수정했어');
